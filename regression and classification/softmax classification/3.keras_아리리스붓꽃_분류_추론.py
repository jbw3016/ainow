...
pre = bestmodel.predict(X_data[149:150]) # 모델 추론(예측)
print('pre : ', pre)
print('target_onehot : ', Y_onehot[149])
print(iris['target_names'])
# np.argmax() ==> 주어진 배열의 가장 큰 값의 인덱스를 반환
final_pre_idx = np.argmax(pre)
print(iris['target_names'][final_pre_idx])
