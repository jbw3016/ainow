...
#titanic_df.dropna(how='any', subset=['Age'], inplace=True)  # 결측치 제거
print(titanic_df.info())
...
#
# titanic_df 와 onehot_Pclass 와 결합(병합)
...
model.summary() # 모델의 형태를 요약 출력



# 모델 학습
model.fit(train_scaled, train_target, batch_size=4, epochs=1000, verbose=1)
